...
public class PGoodsAttrSqlProvider {
        ...
        return new SQL(){
            {
                ...
                if (pGoodsAttr.getId() != null) {VALUES("id", "#{id}");}
                if (pGoodsAttr.getGoodsId() != null) {VALUES("goods_id", "#{goodsId}");}
                if (pGoodsAttr.getName() != null) {VALUES("name", "#{name}");}
                if (pGoodsAttr.getValues() != null) {VALUES("values", "#{values}");}
            }
        }.toString();
    }
    ...
    public String update(PGoodsAttr pGoodsAttr) {
        return new SQL() {
            {
                UPDATE("p_goods_attr");
                if (pGoodsAttr.getGoodsId() != null) {SET("goods_id=#{goodsId}");}
                if (pGoodsAttr.getName() != null) {SET("name=#{name}");}
                if (pGoodsAttr.getValues() != null) {SET("values=#{values}");}
                WHERE("id=#{id}");
            }
        }.toString();
    }
