...
public class ZUserSqlProvider {
    ...
    public String insertSelective(ZUser zUser) {
        return new SQL(){
            {
                INSERT_INTO("z_user");
                if (zUser.getId() != null) {VALUES("id", "#{id}");}
                if (zUser.getUserId() != null) {VALUES("user_id", "#{userId}");}
                if (zUser.getPasswd() != null) {VALUES("passwd", "#{passwd}");}
                if (zUser.getSalt() != null) {VALUES("salt", "#{salt}");}
                if (zUser.getPetName() != null) {VALUES("pet_name", "#{petName}");}
                if (zUser.getMobile() != null) {VALUES("mobile", "#{mobile}");}
                if (zUser.getAllowIpaddr() != null) {VALUES("allow_ipaddr", "#{allowIpaddr}");}
                if (zUser.getNotes() != null) {VALUES("notes", "#{notes}");}
                //if (zUser.getStatus() != null) {VALUES("status", "#{status}");}
                if (zUser.getUpdateOn() != null) {VALUES("update_on", "#{updateOn}");}
                if (zUser.getUpdateBy() != null) {VALUES("update_by", "#{updateBy}");}
                if (zUser.getCreateOn() != null) {VALUES("create_on", "#{createOn}");}
                if (zUser.getCreateBy() != null) {VALUES("create_by", "#{createBy}");}
    ...
    public String update(ZUser zUser) {
        return new SQL() {
            {
                UPDATE("z_user");
                if (zUser.getUserId() != null) {SET("user_id=#{userId}");}
                if (zUser.getPasswd() != null) {SET("passwd=#{passwd}");}
                if (zUser.getSalt() != null) {SET("salt=#{salt}");}
                if (zUser.getPetName() != null) {SET("pet_name=#{petName}");}
                if (zUser.getMobile() != null) {SET("mobile=#{mobile}");}
                if (zUser.getAllowIpaddr() != null) {SET("allow_ipaddr=#{allowIpaddr}");}
                if (zUser.getNotes() != null) {SET("notes=#{notes}");}
                if (zUser.getUpdateOn() != null) {SET("update_on=#{updateOn}");}
                if (zUser.getUpdateBy() != null) {SET("update_by=#{updateBy}");}
                SET("status=#{status}");
                WHERE("id=#{id}");
            }
        }.toString();
