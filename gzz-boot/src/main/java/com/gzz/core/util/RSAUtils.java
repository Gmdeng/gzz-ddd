...
public class RSAUtils {
    ...
    public static byte[] decryptByPrivateKey(byte[] encryptedData, String privateKey) throws Exception {
        byte[] keyBytes = Base64.getDecoder().decode(privateKey);
        PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
        return decryptByPkcs(encryptedData, pkcs8KeySpec);
    }
     ...
     * @throws Exception
     */
    public static byte[] decryptByPkcs(byte[] encryptedData, PKCS8EncodedKeySpec pkcs8KeySpec) throws Exception {
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
    ...
    public static String encryptByPrivateKey(String data, String privateKey) {
        try {
            data = Base64.getEncoder().encodeToString(encryptByPrivateKey(data.getBytes(), privateKey));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return data;
