...
//		}
        ...
        Deque<Serializable> deque = (Deque<Serializable>) redisTemplate.opsForValue().get(getRetrylimitKey(username));
        ...
        redisTemplate.opsForValue().set(getRetrylimitKey(username), deque);
